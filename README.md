...
- `data/paper_portfolio_runtime.json`: current runner heartbeat, phase, warmup/cache counts, REST book-seed progress, best-effort runtime write failure counters, and last cycle summary.
