...
from weather_arb_live.live_fetcher import LiveMarketSnapshot
...
class FakeFetcher:
    ...
    def fetch_yes_midpoint(self, token_id):
        assert token_id == "yes-token"
        return 0.30


class FakeOrderPlacer:
    def place_yes_order(self, *, token_id, market_price, position_usd=None):
